...

{
 ...
 $connection = mysqli_connect("localhost","root","root","travel_agency"); 
	...
	$d_id=$_POST['dob'];
	$p_id=$_POST['phone_no'];
	$a_id=$_POST['accompany_no'];

	
	
	
	
		$query1="update customer set f_name='{$f_id}',l_name='{$l_id}',street='{$s_id}',city='{$ct_id}',DOB='{$d_id}',phn_no='{$p_id}',accompany_no={$a_id}  where customer_id={$c_id}";
