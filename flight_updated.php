...

{
 ...
 $connection = mysqli_connect("localhost","root","root","travel_agency"); 
	...
	$f_id=$_POST['flight_name'];
	$d_id=$_POST['dep_airport'];
	$arv_id=$_POST['arv_country'];
	$a_id=$_POST['arv_airport'];
	
	
	
	
	
		$query1="update flight set flight_name='{$f_id}',dep_airport='{$d_id}',arv_country='{$arv_id}',arv_airport='{$a_id}'  where service_id={$s_id}";
