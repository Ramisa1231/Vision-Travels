...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header4-26" style="background-image: url(assets/images/ws-kathmandu-nepal-1600x12001600x1200-151.jpg);">
        ...
        <div class="mbr-box__container mbr-section__container container">
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
                <div class="row"><div class=" col-sm-8 col-sm-offset-2">
                    ...
                    <div class="mbr-buttons btn-inverse mbr-buttons--center"> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_cbasic_info.php">Edit Personal Info</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_order_info.php">Edit Order Info</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_flight_info.php">Edit Flight Info</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_hotel_info.php">Edit Hotel Info</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_car_info.php">Edit Rental Car Info</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/admin_logout.php">Logout</a>  </div>
                </div></div>
            </div></div>
        </div>
