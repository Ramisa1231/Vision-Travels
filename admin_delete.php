...

{
 ...
 $connection = mysqli_connect("localhost","root","root","travel_agency"); 
	...
	$c_id=$_POST['customer_id'];
		...
		$query1="delete customer,orders,service,flight,hotel,rental_car from customer inner join orders inner join service inner join flight inner join hotel inner join rental_car where customer.customer_id = orders.customer_id and orders.order_id=service.order_id and service.service_id=flight.service_id and service.service_id=hotel.service_id and service.service_id=rental_car.service_id and customer.customer_id={$c_id};";
