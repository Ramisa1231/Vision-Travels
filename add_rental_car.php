...
body
{
background:url(assets/images/places/bangkok.jpg)  #E9E8DC no-repeat left top;
	background-size: 100%;
}
...
if(isset($_POST['submit']))
	...
	//echo $s_id;
	 ...
	 $query1="insert into rental_car(service_id,car_name,pickup_place,pickup_date,dropoff_place,dropoff_date)values($s_id,'$_POST[car_name]','$_POST[pickup_place]','$_POST[pickup_date]','$_POST[dropoff_place]','$_POST[dropoff_date]');";
...
<h1 style='	font-size:800%;color:white;'>Rental car added </br> Please proceed to the next page</h1>
	<form action='complete.php' method='post'>
<input type=hidden name=h7 value="<?php echo $s_id ;?>" />
