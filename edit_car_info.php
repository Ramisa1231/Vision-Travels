...
<section class="mbr-navbar mbr-navbar--freeze mbr-navbar--absolute mbr-navbar--sticky mbr-navbar--auto-collapse" id="menu-15">
 ...
 <table border="1" width="1000" cellpadding="5" cellspacing="1">
    ...
    <tr>
         ...
         <th colspan="9" style="text-align:center"><h3>Rental Car Info</h3></th>
    ...
    <tr>
     ...
     <th style="text-align:center">Car Agency Id</th>
      <th style="text-align:center">Car Name</th>
       <th style="text-align:center">Pickup Place</th>
       <th style="text-align:center">Pickup Date</th>
      <th style="text-align:center">Dropoff Place</th>
...
<form action="http://localhost/travel_agency/car_updated.php" method='post'>
<div style="color:white"  >
<h2>Edit Rental Car Info</h2>

</div>

<p><div style="color:white" >Service ID:</div> <input type="number" name=service_id size=30 required /> </p>
<p><div style="color:white" >Car Name:</div> <select id="car_name"  name="car_name" required>
  ...
  <option value="Audi" selected>Audi</option>
	...
	<p><div style="color:white" >Pick Up Place:</div> <input type=varchar name=pickup_place size=30 required placeholder="Enter a valid pickup place"   required pattern = "[a-zA-Z][a-zA-Z0-9'/.,\s]*" /> </p>
	<p><div style="color:white" >Pick Up Date:</div> <input type="date" name="pickup_date"  min="2015-01-01" max="2020-01-01" required ="[0-9]-[0-9]-[0-9]"/> </p>
	
	
	<p><div style="color:white" >Drop Off Place:</div> <input type=varchar name=dropoff_place size=30  required placeholder="Enter a valid dropoff place"   required pattern = "[a-zA-Z][a-zA-Z0-9'/.,\s]*" /> </p>
	
	
	<p><div style="color:white" >Drop Off Date:</div> <input type="date" name="dropoff_date"  min="2015-01-01" max="2020-01-01" required ="[0-9]-[0-9]-[0-9]"/> </p>
