...
if($username&&$password)
{
	...
	if (mysqli_connect_error()) 
	{
		...
		//echo $numrows;
			...
			if(($username=="rkoadib" && $password=="bracu")  || ($username=="ramisa" && $password=="admin"))
			{
			//	echo "You are in <a href='admin_panel.php'>Click</a> here to enter Admin Panel page";
...
<section class='mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background' id='header4-22' style='background-image: url(assets/images/punakha-dzong1920x1200-122.jpg);'>
        ...
        <div class='mbr-box__container mbr-section__container container'>
            <div class='mbr-box mbr-box--stretched'><div class='mbr-box__magnet mbr-box__magnet--center-center'>
                <div class='row'><div class=' col-sm-8 col-sm-offset-2'>
                    ...
                    <div class='mbr-buttons btn-inverse mbr-buttons--center'> <a class='mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay' href='http://localhost/travel_agency/admin_panel.php'>Enter Admin Panel</a>    </div>
                </div></div>
            </div></div>
        </div>
