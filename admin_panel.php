...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header4-20" style="background-image: url(assets/images/ws-agriculture-himalaya-tibet-1920x10801920x1080-169.jpg);">
        ...
        <div class="mbr-box__container mbr-section__container container">
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
                <div class="row"><div class=" col-sm-8 col-sm-offset-2">
                    ...
                    <div class="mbr-buttons btn-inverse mbr-buttons--center"> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/admin_viewall.php">Customers Info&nbsp;</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/admin_delete_info.php">Delete Customers</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/edit_customer_info.php">Edit Customers</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="http://localhost/travel_agency/admin_logout.php">Logout</a>   </div>
                </div></div>
            </div></div>
        </div>
