...
<div><h2 style="color:white"> Give customer ID to delete all the information about that customer</h2></div>



<form action="http://localhost/travel_agency/admin_delete.php" method="post">
<p>
<h3 style="color:white">Customer ID</h3>
<input type="number" name="customer_id" size="30" value="" />
</p>
