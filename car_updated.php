...

{
 ...
 $connection = mysqli_connect("localhost","root","root","travel_agency"); 
	...
	$c_id=$_POST['car_name'];
	$p_id=$_POST['pickup_place'];
	$pp_id=$_POST['pickup_date'];
	$d_id=$_POST['dropoff_place'];
		$dd_id=$_POST['dropoff_date'];
	
	
	
	
		$query1="update rental_car set car_name='{$c_id}',pickup_place='{$p_id}',pickup_date='{$pp_id}',dropoff_place='{$d_id}',dropoff_date='{$dd_id}'  where service_id={$s_id}";
