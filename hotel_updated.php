...

{
 ...
 $connection = mysqli_connect("localhost","root","root","travel_agency"); 
	...
	$hn_id=$_POST['hotel_name'];
	$c_id=$_POST['country'];
	$cin_id=$_POST['checkin_date'];
	$co_id=$_POST['checkout_date'];
	
	
	
	
	
		$query1="update hotel set hotel_name='{$hn_id}',country='{$c_id}',checkin_date='{$cin_id}' ,checkout_date='{$co_id}' where service_id={$s_id}";
