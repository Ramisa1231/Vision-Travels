...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header4-6" style="background-image: url(assets/images/1211920x1200-161.jpg);">
        ...
        <div class="mbr-box__container mbr-section__container container">
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
                <div class="row"><div class=" col-sm-8 col-sm-offset-2">
                    ...
                    <div class="mbr-buttons btn-inverse mbr-buttons--center">   <a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-default" href="http://localhost/travel_agency/user_index.php">User Login</a> <a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-default" href="http://localhost/travel_agency/admin_index.php">Admin Login</a>  </div>
                </div></div>
            </div></div>
        </div>
